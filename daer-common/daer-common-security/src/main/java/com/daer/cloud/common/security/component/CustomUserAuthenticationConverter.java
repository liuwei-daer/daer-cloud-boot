package com.daer.cloud.common.security.component;
 ...
 */
public class CustomUserAuthenticationConverter implements org.springframework.security.oauth2.provider.token.UserAuthenticationConverter {
	...
	public Authentication extractAuthentication(Map<String, ?> map) {
		if (map.containsKey(USERNAME)) {
			...
			AuthUser user = new AuthUser(id, deptId, username, N_A, true, true, true, true, authorities);
